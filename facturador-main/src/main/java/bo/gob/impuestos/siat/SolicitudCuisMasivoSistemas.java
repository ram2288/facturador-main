/**
 * SolicitudCuisMasivoSistemas.java
 *
...
public class SolicitudCuisMasivoSistemas  implements java.io.Serializable {
    ...
    private bo.gob.impuestos.siat.SolicitudListaCuisDto[] datosSolicitud;

    private long nit;

    public SolicitudCuisMasivoSistemas() {
    }
    ...
    public SolicitudCuisMasivoSistemas(
           ...
           bo.gob.impuestos.siat.SolicitudListaCuisDto[] datosSolicitud,
           long nit) {
    ...
    /**
     * Gets the codigoAmbiente value for this SolicitudCuisMasivoSistemas.
     * 
    ...
    /**
     * Sets the codigoAmbiente value for this SolicitudCuisMasivoSistemas.
     * 
    ...
    /**
     * Gets the codigoModalidad value for this SolicitudCuisMasivoSistemas.
     * 
    ...
    /**
     * Sets the codigoModalidad value for this SolicitudCuisMasivoSistemas.
     * 
    ...
    /**
     * Gets the codigoSistema value for this SolicitudCuisMasivoSistemas.
     * 
    ...
    /**
     * Sets the codigoSistema value for this SolicitudCuisMasivoSistemas.
     * 
     * @param codigoSistema
     */
    ...
    /**
     * Gets the datosSolicitud value for this SolicitudCuisMasivoSistemas.
     * 
     * @return datosSolicitud
     */
    public bo.gob.impuestos.siat.SolicitudListaCuisDto[] getDatosSolicitud() {
        return datosSolicitud;
    }


    /**
     * Sets the datosSolicitud value for this SolicitudCuisMasivoSistemas.
     * 
     * @param datosSolicitud
     */
    public void setDatosSolicitud(bo.gob.impuestos.siat.SolicitudListaCuisDto[] datosSolicitud) {
        this.datosSolicitud = datosSolicitud;
    }

    public bo.gob.impuestos.siat.SolicitudListaCuisDto getDatosSolicitud(int i) {
        return this.datosSolicitud[i];
    }

    public void setDatosSolicitud(int i, bo.gob.impuestos.siat.SolicitudListaCuisDto _value) {
        this.datosSolicitud[i] = _value;
    }


    /**
     * Gets the nit value for this SolicitudCuisMasivoSistemas.
     * 
     * @return nit
     */
    public long getNit() {
    ...
    /**
     * Sets the nit value for this SolicitudCuisMasivoSistemas.
     * 
     * @param nit
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SolicitudCuisMasivoSistemas)) return false;
        SolicitudCuisMasivoSistemas other = (SolicitudCuisMasivoSistemas) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SolicitudCuisMasivoSistemas.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://siat.impuestos.gob.bo/", "solicitudCuisMasivoSistemas"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://siat.impuestos.gob.bo/", "solicitudListaCuisDto"));
        elemField.setNillable(false);
